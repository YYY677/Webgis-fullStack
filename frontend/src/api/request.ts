...
import { backendUnavailableMessage, canRequestBackend } from "@/services/backend-status"
...
instance.defaults.baseURL = import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_BASE_URL
