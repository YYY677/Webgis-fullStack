...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    path: "/map-demo",
    component: Layouts,
    redirect: "/map-demo/openlayers-tianditu",
    name: "MapDemo",
    meta: {
      title: "Map Demo",
      elIcon: "MapLocation"
    ...
    children: [
      {
        ...
        component: () => import("@/pages/demo/openlayers/index.vue"),
        name: "OpenLayersTianditu",
        meta: {
          title: "OpenLayers 天地图",
          keepAlive: false
        }
      },
      {
        path: "openlayers-wfs",
        component: () => import("@/pages/demo/openlayers-wfs/index.vue"),
        name: "OpenLayersWfs",
        meta: {
          title: "OpenLayers WFS 查询",
          keepAlive: false
        }
      },
      {
        path: "cesium",
        component: () => import("@/pages/demo/cesium/index.vue"),
        name: "Cesium",
        meta: {
          title: "Cesium 3D 地球",
          keepAlive: false
